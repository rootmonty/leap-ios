...
#ifndef LEAPCORESDK_SWIFT_H
#define LEAPCORESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LeapCoreSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11LeapCoreSDK8LeapCore")
@interface LeapCore : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LeapCore * _Nonnull shared;)
+ (LeapCore * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
